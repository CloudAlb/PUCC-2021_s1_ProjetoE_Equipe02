...
export class SeuPerfilService {
  ...
  constructor(private http: HttpClient,
    ...
    // sempre que for instanciado, o construtor vai pegar o header
    // assim, cada método pode usar o atributo "headers" para pegar o token de sessão
  ...
  public getUserSocial(): Observable<UserSocialResponse> {
    return this.http.get<UserSocialResponse>(environment.baseUrl + "/users/social/",
      {
        headers: this.headers
      });
  }
  ...
  public editUser(body: EditUserInfo): Observable<MessageData> {
    return this.http.patch<MessageData>(environment.baseUrl + "/users/edit/", body,
      {
        headers: this.headers
      });
  }
  ...
  public editUserSocialInfo(body: UserSocialRequest): Observable<MessageData> {
    return this.http.patch<MessageData>(environment.baseUrl + "/users/edit/social/", body,
      {
        headers: this.headers
      });
  }
  ...
  public editPassword(body: EditUserPassword): Observable<MessageData> {
    return this.http.patch<MessageData>(environment.baseUrl + "/users/edit/password/", body,
      {
        headers: this.headers
      });
  }
